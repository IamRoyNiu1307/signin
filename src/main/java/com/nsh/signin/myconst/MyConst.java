...
public class MyConst {
    ...
    //图片所在的请求路径
    public static final String IMAGE_PATH = HOST+"/static/fileUpload/";
    //微信小程序appid
    ...
    //图片保存路径
    public static final String UPLOAD_FILEPATH = "/Users/roy/project/signin/src/main/resources/static/fileUpload/";
